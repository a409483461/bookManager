				...
				if(xhr.readyState==4){
					if(xhr.status==200){
						...
						for(var i=0;i<ss.length;i++){
							childDivs+="<div onmouseover='changeBackground_over(this)'>+ss[i]+</div>";
						}
...
<div id="context1" style="border:1px solid red;background-color:white;width:128px;height:100px;position:absolute;left:642px;top:135px;">
