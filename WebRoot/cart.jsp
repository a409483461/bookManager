...
<script type="text/javascript">
	function changeProductNum(num,totalcount,id){
		...
		location.href="${pageContext.request.contextPath}/servlet/changeNum?id="+id+"&num="+num+"&total="+totalcount;
											...
											<c:forEach items="${cart }" var="entry" varStatus="vs">
												...
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="10%"><a href="${pageContext.request.contextPath}/servlet/changeNum?id=${entry.key.id}&num=0"
